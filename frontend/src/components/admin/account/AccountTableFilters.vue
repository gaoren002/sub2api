<template>
  <div class="flex flex-wrap items-center gap-3">
    ...
    <Select :model-value="filters.image_quota" class="w-40" :options="imageQuotaOpts" @update:model-value="updateImageQuota" @change="$emit('change')" />
...
const updateImageQuota = (value: string | number | boolean | null) => { emit('update:filters', { ...props.filters, image_quota: value }) }
...
const imageQuotaOpts = computed(() => [{ value: '', label: t('admin.accounts.allImageQuota') }, { value: 'exhausted', label: t('admin.accounts.imageQuota.exhausted') }])
